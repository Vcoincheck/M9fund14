...
### Current Gaps in Midnight’s Technical Infrastructure

#### 1. **Not Yet Live on Mainnet**

According to Midnight’s roadmap, several critical features have yet to be deployed on mainnet, including:

* **Token Bridges** — for asset transfers across blockchains.
* **ZK recursion** — enabling nested zero-knowledge proofs to improve efficiency and security.
...
#### 2. **Lack of Sustainable Post-Mainnet Operations**

Currently, there’s limited clarity on:
...
#### 3. **Underdeveloped Ecosystem and Tooling**

From a technical perspective, certain developer support and infrastructure elements could be expanded:
...
#### 4. **Unclear Technical Roadmap Details**
...
### Technical Gaps Overview Table

| Feature / Infrastructure        | Current Status                       |
| ------------------------------- | ------------------------------------ |
| Token Bridges                   | Not yet deployed on mainnet          |
| ZK Recursion                    | Not yet deployed                     |
| Customizable Compliance         | No specific implementation yet       |
| Multi-Resource Consensus        | No confirmed implementation          |
| Capacity Lease Exchange         | Still in planning phase              |
| ZK Trustless Bridge             | Not yet deployed                     |
| Official Monitoring/Telemetry   | No clear documentation or deployment |
| SDKs for other languages        | Unclear or incomplete                |
| DAO/On-chain Governance Tooling | Not yet available or public          |
